...
make_top_up_operations_response = operations_gateway_client.make_top_up_operation(card_id, account_id)
print(f"Make top up operation response: {make_top_up_operations_response}")
